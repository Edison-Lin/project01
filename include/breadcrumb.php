...
if(isset($_GET['p_id'])&& $_GET['p_id']!=""){
  ...
  $level2Open='<li class="breadcrumb-item"><a href="drugstore.php?classid='.$level2Classid.'">'. $level1Cname.'</a></li>';
  //處理第三層(產品名稱)
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="drugstore.php">全部商品</a></li>
